...
namespace SpyPlugin
{
    ...
    /// <inheritdoc />
    public class SpyPlugin : Plugin<Config>
    {
        /// <summary>
        ...
        /// <inheritdoc />
        public override string Name { get; } = "Spy";

        /// <inheritdoc />
        public override string Prefix { get; } = "Spy";

        /// <inheritdoc />

        /// <summary>
        /// Gets the reference to this SpyPlugin's Event Handler class.
        /// </summary>
